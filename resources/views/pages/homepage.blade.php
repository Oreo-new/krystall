...
<x-app-layout>
<div class="w-full md:p-2 md:m-2 md:flex md:flex-wrap lg:flex-nowrap lg:flex-col lg:m-0 lg:p-0">
        <div class="flex flex-col-reverse w-full py-5 md:px-2 border-t-2 justify-between md:justify-end items-start group md:w-1/2 lg:px-0 lg:flex-row lg:w-full lg:justify-between">
            ...
            <div class="w-full  lg:w-1/2">
                <a href="" class="block h-80 bg-contain md:h-44 sm:bg-cover md:bg-contain lg:bg-contain lg:h-48 xl:bg-cover xl:h-64 bg-center bg-no-repeat" style="background-image: url('{{ asset('images/6ddb2450462828abf9aabc88d6bfb7fe_L.jpg') }}')"></a><!-- <img class="h-1/2" src="{{ asset('images/6ddb2450462828abf9aabc88d6bfb7fe_L.jpg') }}" alt=""> -->
            </div>
        </div>  
        <div class="flex flex-col-reverse w-full py-5 md:px-2 border-t-2 justify-between md:justify-end items-start group md:w-1/2 lg:px-0 lg:flex-row lg:w-full lg:justify-between">
            <div class="w-full  lg:w-1/2 xl:w-96">
            ...
            <div class="w-full  lg:w-1/2">
                <a href="" class="block h-80 bg-contain md:h-44 sm:bg-cover md:bg-contain lg:bg-contain lg:h-48 xl:bg-cover xl:h-64 bg-center bg-no-repeat" style="background-image: url('{{ asset('images/4246b121d2dc949b8f082c5f57840a3b_M.jpg') }}')"></a><!-- <img class="" src="{{ asset('images/4246b121d2dc949b8f082c5f57840a3b_M.jpg') }}" alt=""> -->
            </div>
        </div>
